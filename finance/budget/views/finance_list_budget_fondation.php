                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        <li class="breadcrumb-item text-muted">
                            <a href="" class="text-muted">Daftar Anggaran Yayasan</a>
                        </li>                       
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                    ...
                    <div class="card card-custom">
                        <div class="card-header">
                            <div class="card-title">
                                ...
                                <h3 class="card-label">Daftar Anggaran Yayasan</h3>
                            </div>
                            ...
                            <form class="mb-6">
                                <div class="row mb-6">
                                        ...
                                        <select class="form-control datatable-input" data-col-index="2">
                                            ...
                                            if (!empty($account)) {
                                                foreach ($account as $key => $value) {
                                                    ?> 
                                                    <option value="<?php echo $value->nama_akun; ?>"><?php echo strtoupper(strtolower($value->nama_akun)); ?></option>
                                                    <?php
                                                }  //ngatur nomor urut
                                            }
                                            ?>       
                                        ...
                                        <select class="form-control datatable-input" data-col-index="3">
                                            ...
                                            if (!empty($structure)) {
                                                foreach ($structure as $key => $value) {
                                                    ?> 
                                                    <option value="<?php echo $value->nama_struktur; ?>"><?php echo strtoupper(strtolower($value->nama_struktur)); ?></option>
                                                    <?php
                                                }  //ngatur nomor urut
                                            }
                                            ?>       
                                    ...
                                    <div class="col-lg-2 mb-lg-0 mb-6">
                                        ...
                                        <input type="text" class="form-control datatable-input" placeholder="Inputkan Dana Diajukan" data-col-index="4" />
                                    </div>
                                    <div class="col-lg-2 mb-lg-0 mb-6">
                                ...
                                <div class="row mb-8">
                                    ...
                                    <div class="col-lg-2 mb-lg-0 mb-6">
                                        ...
                                        <input type="text" class="form-control datatable-input" placeholder="Inputkan Dana Terpakai" data-col-index="8" />
                                    </div>
                                    <div class="col-lg-2 mb-lg-0 mb-6">
                                        <label>Dana Sisa:</label>
                                        <input type="text" class="form-control datatable-input" placeholder="Inputkan Dana Sisa" data-col-index="9" />
                                    </div>
                                    <div class="col-lg-2 mb-lg-0 mb-6">
                                    ...
                                    if (!empty($budget)) {
                                        foreach ($budget as $key => $value) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="font-weight-bolder text-primary"><?php echo strtoupper($value->nama_akun); ?></td>
                                                <td class="font-weight-bolder text-warning"><?php echo strtoupper($value->nama_struktur); ?></td>
                                                            ...
                                                            <ul class="nav nav-hover flex-column">
                                                                <?php if ($user[0]->id_role_struktur == 5) { ?>
                                                                    <?php if ($value->status_acc_proposal == 0) { ?>
                                                                        ...
                                                                        <?php } ?>
                                                                        <li class="nav-item"><a class="nav-link" href="<?php echo site_url("/finance/budget/confirm_bendahara_budget_fondation/" . paramEncrypt($value->id_anggaran)); ?>"><i class="nav-icon la la-hand-pointer text-success"></i><span class="nav-text text-success font-weight-bold text-hover-primary">Acc Proposal</span></a></li>
                                                                    <?php } else if ($value->status_acc_proposal == 1) { ?>
                                                                        <li class="nav-item"><a class="nav-link" href="<?php echo site_url("/finance/budget/confirm_bendahara_budget_fondation/" . paramEncrypt($value->id_anggaran)); ?>"><i class="nav-icon la la-pencil-ruler text-warning"></i><span class="nav-text text-warning font-weight-bold text-hover-primary">Ubah File Prop.</span></a></li>
                                                                    <?php } else if ($value->status_acc_proposal == 3) { ?>
                                                                        <li class="nav-item"><a class="nav-link" href="<?php echo site_url("/finance/budget/edit_proposal_fondation/" . paramEncrypt($value->id_anggaran)); ?>"><i class="nav-icon la la-pencil-ruler text-warning"></i><span class="nav-text text-warning font-weight-bold text-hover-primary">Revisi Anggaran</span></a></li>
                                                                    <?php } ?>
                                                                    ...
                                                                    <?php if ($value->status_acc_lpj == 1) { ?>
                                                                        ...
                                                                        <?php } ?>
                                                                        <li class="nav-item"><a class="nav-link" href="<?php echo site_url("/finance/budget/confirm_bendahara_lpj_fondation/" . paramEncrypt($value->id_anggaran)); ?>"><i class="nav-icon la la-hand-pointer text-success"></i><span class="nav-text text-success font-weight-bold text-hover-primary">Acc LPJ</span></a></li>
                                                                    <?php } else if ($value->status_acc_lpj == 2) { ?>
                                                                        <li class="nav-item"><a class="nav-link" href="<?php echo site_url("/finance/budget/confirm_bendahara_lpj_fondation/" . paramEncrypt($value->id_anggaran)); ?>"><i class="nav-icon la la-pencil-ruler text-warning"></i><span class="nav-text text-warning font-weight-bold text-hover-primary">Ubah File LPJ</span></a></li>
                                                                    <?php } else if ($value->status_acc_lpj == 3) { ?>
                                                                        ...
                                                                        <?php } ?>
                                                                    <?php } ?>
                                                                    <?php if ($value->status_acc_proposal == 2) { ?>
                                                                        <li class="nav-item"><a class="nav-link" href="<?php echo site_url("/finance/budget/upload_recipe_fondation/" . paramEncrypt($value->id_anggaran)); ?>"><i class="nav-icon la la la-upload text-primary"></i><span class="nav-text text-primary font-weight-bold text-hover-primary">Upload Bukti</span></a></li>
                                                                    <?php } ?>
                                                                <?php } else if ($user[0]->id_role_struktur == 2) { ?>
                                                                    <?php if ($value->status_acc_proposal == 1) { ?>
                                                                        <li class="nav-item"><a class="nav-link" href="<?php echo site_url("/finance/budget/confirm_ketua_prop_fondation/" . paramEncrypt($value->id_anggaran)); ?>"><i class="nav-icon la la-hand-pointer text-success"></i><span class="nav-text text-success text-hover-primary">Acc Proposal</span></a></li>        
                                                                    <?php } ?>
                                                                <?php } else { ?>
                                                                    <?php if ($user[0]->id_akun_keuangan == $value->id_akun_keuangan) { ?>                                                               
                                                                        <?php if ($value->status_acc_proposal == 2 && $value->status_acc_lpj == 0) { ?>
...
<!--end::Content-->
<script src="<?php echo base_url(); ?>assets/finance/dist/assets/js/pages/crud/datatables/search-options/budget-fondation.js">
</script>
<script>
    function act_delete_budget(id, name) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "post",
                    url: "<?php echo site_url("/finance/budget/delete_budget_fondation") ?>",
