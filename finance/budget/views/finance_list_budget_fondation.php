                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-custom">
                        ...
                        <div class="card-body">
                            ...
                            <form class="mb-6">
                                <div class="row mb-6">
                                    <div class="col-lg-2 mb-lg-0 mb-6">
                                        ...
                                        <input type="text" class="form-control datatable-input"
                                            placeholder="Inputkan Nama Anggaran" data-col-index="1" />
                                    </div>
                                    <div class="col-lg-2 mb-lg-0 mb-6">
                                        <label>Pemohon:</label>
                                        <select class="form-control datatable-input" data-col-index="2">
                                            ...
                                            if (!empty($account)) {
                                                foreach ($account as $key => $value) {
                                                    ?>
                                            <option value="<?php echo $value->nama_akun; ?>">
                                                <?php echo strtoupper(strtolower($value->nama_akun)); ?></option>
                                            <?php
                                                }  //ngatur nomor urut
                                            }
                                            ?>
                                        ...
                                        <select class="form-control datatable-input" data-col-index="3">
                                            ...
                                            if (!empty($structure)) {
                                                foreach ($structure as $key => $value) {
                                                    ?>
                                            <option value="<?php echo $value->nama_struktur; ?>">
                                                <?php echo strtoupper(strtolower($value->nama_struktur)); ?></option>
                                            <?php
                                                }  //ngatur nomor urut
                                            }
                                            ?>
                                    ...
                                    <div class="col-lg-2 mb-lg-0 mb-6">
                                        ...
                                        <input type="text" class="form-control datatable-input"
                                            placeholder="Inputkan Dana Diajukan" data-col-index="4" />
                                    </div>
                                    <div class="col-lg-2 mb-lg-0 mb-6">
                                    ...
                                    <div class="col-lg-2 mb-lg-0 mb-6">
                                        ...
                                        <input type="text" class="form-control datatable-input"
                                            placeholder="Inputkan Dana Acc" data-col-index="6" />
                                    </div>
                                ...
                                <div class="row mb-8">
                                    <div class="col-lg-2 mb-lg-0 mb-6">
                                        ...
                                        <input type="text" class="form-control datatable-input"
                                            placeholder="Inputkan Dana Eksternal" data-col-index="7" />
                                    </div>

                                    <div class="col-lg-2 mb-lg-0 mb-6">
                                        <label>Dana Terpakai:</label>
                                        <input type="text" class="form-control datatable-input"
                                            placeholder="Inputkan Dana Terpakai" data-col-index="8" />
                                    </div>
                                    <div class="col-lg-2 mb-lg-0 mb-6">
                                        <label>Dana Sisa:</label>
                                        <input type="text" class="form-control datatable-input"
                                            placeholder="Inputkan Dana Sisa" data-col-index="9" />
                                    </div>
                                    <div class="col-lg-2 mb-lg-0 mb-6">
                            ...
                            <!--begin: Datatable-->
                            <!--begin: Datatable-->
                            <table class="table table-separate table-hover table-light-warning table-checkable"
                                id="kt_datatable">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="font-weight-bolder">
                                            <?php echo ucwords(strtolower($value->nama_anggaran)); ?></td>
                                        <td class="font-weight-bolder text-primary">
                                            <?php echo strtoupper($value->nama_akun); ?></td>
                                        <td class="font-weight-bolder text-warning">
                                            <?php echo strtoupper($value->nama_struktur); ?></td>
                                        <td class="font-weight-bolder">
                                            <?php echo number_format($value->nominal_dana_awal, 0, ',', '.'); ?></td>
                                                ...
                                                <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                    <ul class="nav nav-hover flex-column">
                                                        ...
                                                        <li class="nav-item"><a class="nav-link"
                                                                href="<?php echo site_url("/finance/budget/edit_proposal_fondation/" . paramEncrypt($value->id_anggaran)); ?>"><i
                                                                    class="nav-icon la la-pencil-ruler text-warning"></i><span
                                                                    class="nav-text text-warning font-weight-bold text-hover-primary">Edit
                                                                    Anggaran</span></a></li>
                                                        <li class="nav-item"><a class="nav-link"
                                                                href="javascript:act_delete_budget('<?php echo paramEncrypt($value->id_anggaran); ?>', '<?php echo strtoupper($value->nama_anggaran); ?>')"><i
                                                                    class="nav-icon la la-trash text-danger"></i><span
                                                                    class="nav-text text-danger font-weight-bold text-hover-primary">Hapus
                                                                    Anggaran</span></a></li>
                                                        <?php } ?>
                                                        <li class="nav-item"><a class="nav-link"
                                                                href="<?php echo site_url("/finance/budget/confirm_bendahara_budget_fondation/" . paramEncrypt($value->id_anggaran)); ?>"><i
                                                                    class="nav-icon la la-hand-pointer text-success"></i><span
                                                                    class="nav-text text-success font-weight-bold text-hover-primary">Acc
                                                                    Proposal</span></a></li>
                                                        <?php } else if ($value->status_acc_proposal == 1) { ?>
                                                        <li class="nav-item"><a class="nav-link"
                                                                href="<?php echo site_url("/finance/budget/confirm_bendahara_budget_fondation/" . paramEncrypt($value->id_anggaran)); ?>"><i
                                                                    class="nav-icon la la-pencil-ruler text-warning"></i><span
                                                                    class="nav-text text-warning font-weight-bold text-hover-primary">Ubah
                                                                    File Prop.</span></a></li>
                                                        <?php } else if ($value->status_acc_proposal == 3) { ?>
                                                        <li class="nav-item"><a class="nav-link"
                                                                href="<?php echo site_url("/finance/budget/edit_proposal_fondation/" . paramEncrypt($value->id_anggaran)); ?>"><i
                                                                    class="nav-icon la la-pencil-ruler text-warning"></i><span
                                                                    class="nav-text text-warning font-weight-bold text-hover-primary">Revisi
                                                                    Anggaran</span></a></li>
                                                        <?php } ?>
                                                        <?php if ($value->status_acc_proposal == 2 && $value->status_acc_lpj == 0) { ?>
                                                        <?php if ($user[0]->id_akun_keuangan == $value->id_akun_keuangan) { ?>
                                                        <li class="nav-item"><a class="nav-link"
                                                                href="<?php echo site_url("/finance/budget/upload_lpj_fondation/" . paramEncrypt($value->id_anggaran)); ?>"><i
                                                                    class="nav-icon la la-upload text-success"></i><span
                                                                    class="nav-text text-success font-weight-bold text-hover-primary">Upload
                                                                    LPJ</span></a></li>
                                                        <?php } ?>
                                                        <?php } ?>
                                                        ...
                                                        <?php } ?>
                                                        <li class="nav-item"><a class="nav-link"
                                                                href="<?php echo site_url("/finance/budget/confirm_bendahara_lpj_fondation/" . paramEncrypt($value->id_anggaran)); ?>"><i
                                                                    class="nav-icon la la-hand-pointer text-success"></i><span
                                                                    class="nav-text text-success font-weight-bold text-hover-primary">Acc
                                                                    LPJ</span></a></li>
                                                        ...
                                                        <li class="nav-item"><a class="nav-link"
                                                                href="<?php echo site_url("/finance/budget/upload_recipe_fondation/" . paramEncrypt($value->id_anggaran)); ?>"><i
                                                                    class="nav-icon la la la-upload text-primary"></i><span
                                                                    class="nav-text text-primary font-weight-bold text-hover-primary">Upload
                                                                    Bukti</span></a></li>
                                                        <?php } ?>
                                                        <?php } else if ($user[0]->id_role_struktur == 2) { ?>
                                                        <?php if ($value->status_acc_proposal == 1) { ?>
                                                        <li class="nav-item"><a class="nav-link"
                                                                href="<?php echo site_url("/finance/budget/confirm_ketua_prop_fondation/" . paramEncrypt($value->id_anggaran)); ?>"><i
                                                                    class="nav-icon la la-hand-pointer text-success"></i><span
                                                                    class="nav-text text-success text-hover-primary">Acc
                                                                    Proposal</span></a></li>
                                                        <?php } ?>
                                                        <?php } else { ?>
                                                        <?php if ($user[0]->id_akun_keuangan == $value->id_akun_keuangan) { ?>
                                                        ...
                                                        <?php } ?>
                                                        <li class="nav-item"><a class="nav-link"
                                                                href="<?php echo site_url("/finance/budget/detail_budget_fondation/" . paramEncrypt($value->id_anggaran)); ?>"><i
                                                                    class="nav-icon la la-eye "></i><span
...
<!--end::Content-->
<script
    src="<?php echo base_url(); ?>assets/finance/dist/assets/js/pages/crud/datatables/search-options/budget-fondation.js">
</script>
<script>
        ...
        if (result.value) {
            $.ajax({
                ...
                success: function(result) {
                    Swal.fire("Terhapus!", "Anggaran atas nama '" + name + "' telah terhapus.",
                        "success");
                    setTimeout(function() {
                        location.reload();
                    }, 1000);
