                            ...
                            <div class="mb-7">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-3 col-xl-4 text-right">
                                        <a href="<?php echo site_url("/finance/settings/account/add_account"); ?>" class="btn btn-primary btn-md" >
                                                    ...
                                                    <div class="dropdown dropdown-inline">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                            <ul class="navi flex-column navi-hover py-2">
                                                                ...
                                                                <li  class="navi-item">
                                                                    <a href="<?php echo site_url("/finance/settings/account/edit_account/" . paramEncrypt($value->id_akun_keuangan)); ?>" class="navi-link">
                                                                        <span class="navi-icon"><i class="la la-edit text-success"></i></span>
                                                                        <span class="navi-text">Edit</span>
                                                                    </a>
                                                                </li>
                                                                <li class="navi-item">
                                                                    <a href="javascript:act_delete_account('<?php echo paramEncrypt($value->id_akun_keuangan); ?>', '<?php echo strtoupper($value->nama_akun); ?>')"  class="navi-link">
...
<!--end::Content-->
<script src="<?php echo base_url(); ?>assets/finance/dist/assets/js/pages/crud/ktdatatable/base/html-table-account.js">
</script>
<script>
    function act_delete_account(id, name) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "post",
                    url: "<?php echo site_url("/finance/settings/account/delete_account") ?>",
