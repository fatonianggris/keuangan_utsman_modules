                    ...
                    <div class="card card-custom">
                        <div class="card-header pt-4 pb-1" style="justify-content: center">
                            <div class="card-title">
                                <h2 class="card-label font-size-h1 text-center font-weight-bolder text-danger">KONFIRMASI IMPOR DATA TAGIHAN DPB SEKOLAH
                                    <span class="text-dark-75 pt-1 font-size-h6 font-weight-bold d-block">Berikut merupakan hasil impor tagihan DPB siswa Sekolah Utsman</span>
                                </h2>
                            </div>
                        </div>                        
                        <div class="card-body">
                            ...
                            <!--begin: Datatable-->
                            <table class="table table-separate table-hover table-light-success table-checkable" id="kt_datatable_income_dpb_invoice_success">
                                <thead>
                                    <tr>
                                        <th>ID Invoice</th>   
                                        <th>No Pembayaran</th>
                            ...
                            <?php if (!empty($income_update)) { ?>
                                <div class="alert alert-warning text-center font-weight-bolder " role="alert">
                                    Data Import Pembayaran DPB Yang Akan Memperbarui Data Database Telah Ada Dengan Kode Invoice Sama & Status "MENUNGGU"  (<a class="blink-hard text-white text-hover-primary font-weight-boldest" href="#" data-toggle="modal" data-target="#modal_list_income_update" >KILK LIHAT DUPLIKAT</a>)
                                </div>
                                <!--begin: Datatable-->
                                <table class="table table-separate table-hover table-light-warning table-checkable" id="kt_datatable_income_dpb_invoice_warning">
                                    <thead>
                                        <tr>
                                            <th>ID Invoice</th>   
                                            <th>No Pembayaran</th>
                            ...
                            <?php if (!empty($income_delete)) { ?>
                                <div class="alert alert-danger text-center font-weight-bolder " role="alert">
                                    Data Import Pembayaran DPB Yang Tidak Terinput Kedalam Database Dengan Kode Invoice Sama & Status "SUKSES"  (<a class="blink-hard text-white text-hover-primary font-weight-boldest" href="#" data-toggle="modal" data-target="#modal_list_income_delete" >KILK LIHAT DUPLIKAT</a>)
                                </div>
                                <!--begin: Datatable-->
                                <table class="table table-separate table-hover table-light-danger table-checkable" id="kt_datatable_income_dpb_invoice_danger">
                                    <thead>
                                        <tr>
                                            <th>ID Invoice</th>   
                                            <th>No Pembayaran</th>
...
<div class="modal fade" id="modal_list_income_update" tabindex="-1" aria-labelledby="exampleModalSizeLg" aria-hidden="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Daftar Tagihan DPB Siswa Sebelumnya Yang Tersimpan Di Database</h5>
            ...
            <div class="modal-body">                   
                <div class="row">
                    <?php if (!empty($income_update_dup)) { ?>                        
                        <table class="table table-separate table-hover table-light-warning font-size-sm">
                            <thead>
                                <tr>
                                    <th>ID Invoice</th>   
                                    <th>No Pembayaran</th>
                            ...
                            <tbody>
                                <?php
                                foreach ($income_update_dup as $key => $value) {
                                    ?>
                                    <tr>
                                        <td class="font-weight-bolder">
                                            <?php echo $value->id_invoice; ?>
                                        ...
                                        <td><?php echo $value->tahun_ajaran; ?></td>                    
                                        <td class="font-weight-bolder"><?php echo strtoupper(strtolower($value->semester)); ?></td>
                                        <td class="font-weight-bolder"><?php echo strtoupper(strtolower(bulanindo($value->bulan_invoice))); ?></td>
                                    </tr>
                                    <?php
                                }  //ngatur nomor urut
                                ?>         
...
<div class="modal fade" id="modal_list_income_delete" tabindex="-1" aria-labelledby="exampleModalSizeLg" aria-hidden="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Daftar Tagihan DPB Siswa Sebelumnya Yang Tersimpan Di Database</h5>
            ...
            <div class="modal-body">                   
                <div class="row">
                    <?php if (!empty($income_delete_dup)) { ?>                        
                        <table class="table table-separate table-hover table-light-danger font-size-sm">
                            <thead>
                                <tr>
                                    <th>ID Invoice</th>   
                                    <th>No Pembayaran</th>
                            ...
                            <tbody>
                                <?php
                                foreach ($income_delete_dup as $key => $value) {
                                    ?>
                                    <tr>
                                        <td class="font-weight-bolder">
                                            <?php echo $value->id_invoice; ?>
...
<!--end::Content-->
<script src="<?php echo base_url(); ?>assets/finance/dist/assets/js/pages/crud/datatables/search-options/budget-income-dpb-transition.js">
</script>
<script>
        ...
        Swal.fire({
            ...
            preConfirm: (text) => {
                return $.ajax({
                    ...
                    data: {password: text, [csrfName]: csrfHash},
                    dataType: 'html',
                    success: function (result) {
                        if (result == 1) {
                            Swal.fire("Berhasil!", "Persetujuan Impor Data Tagihan telah dilakukan.", "success");
                            setTimeout(function () {
                                window.location.replace("<?php echo site_url("finance/income/income/list_income_dpb") ?>");
                            }, 1000);
                        } else {
