				...
				<div class="col-lg-12">
					...
					<div class="card card-custom">
						...
						<div class="card-body">
											...
											<div class="row mb-6">
												...
												<div class="col-lg-2 mb-lg-0 mb-6">
													...
													<select class="form-control datatable-input" data-col-index="9">
														...
														?>
																	<option value="<?php echo $value->id_tahun_ajaran; ?>" selected><?php echo $value->tahun_awal; ?>/<?php echo $value->tahun_akhir; ?></option>
																<?php
																} else {
																?>
							...
							<!--begin: Datatable-->
							<table class="table table-separate table-hover table-light-primary table-checkable" id="kt_datatable_income_du">
								<thead>
									<tr>
...
<script src="<?php echo base_url(); ?>assets/finance/dist/assets/js/pages/crud/datatables/search-options/budget-income-du-server.js">
</script>
<script>
