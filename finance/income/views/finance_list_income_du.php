    ...
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            ...
            <form class="form" method="POST"
                action="<?php echo site_url('finance/income/income/search_student_payment_du'); ?>"
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="nomor_pembayaran_du"
                                    class="form-control form-control-solid form-control-lg "
                                    placeholder="Inputkan Nomor Pembayaran DU Siswa">
                                <span class="form-text text-dark"><b class="text-danger">*WAJIB DIISI, </b>Inputkan
                                    Nomor Pembayaran DU Siswa</span>
                            </div>
                        </div>
                    </div>
                </div>
...
<!--end::Content-->
<script
    src="<?php echo base_url(); ?>assets/finance/dist/assets/js/pages/crud/forms/validation/form-controls-search-payment_du.js">
</script>
<script
    src="<?php echo base_url(); ?>assets/finance/dist/assets/js/pages/crud/datatables/search-options/budget-income-du-server.js">
</script>
<script>
