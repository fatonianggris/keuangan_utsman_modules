                    ...
                    <div class="card card-custom">
                        <div class="card-header pt-4 pb-1" style="justify-content: space-between">
                            ...
                            <div class="card-title">
                                <h2 class="card-label font-size-h2 text-center font-weight-bolder">DAFTAR TAGIHAN SISWA DU SEKOLAH
                                    <span class="text-warning pt-1 font-size-h6 font-weight-bold d-block">Berikut merupakan daftar tagihan/pemasukan DU siswa Sekolah Utsman</span>
                                </h2>
                            </div>
                            <div class="card-toolbar">
                                                    ...
                                                    <div class="dropdown dropdown-inline">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                            ...
                                                            <?php if ($value->status_pembayaran == "MENUNGGU") { ?>
                                                                ...
                                                                <ul class="nav nav-hover flex-column">    
                                                                    <li class="nav-item"><a class="nav-link" href='javascript:act_delete_income("<?php echo paramEncrypt($value->id_tagihan_pembayaran_du); ?>", "<?php echo strtoupper(preg_replace('/[^A-Za-z0-9\-]/', ' ', $value->nama_lengkap)); ?>", "<?php echo strtoupper($value->nis); ?>")'><i class="nav-icon fas fa-trash text-danger"></i><span class="nav-text text-danger font-weight-bold text-hover-primary">Hapus Tagihan</span></a></li>
                                                                </ul> 
                                                            <?php } ?> 
                                                        </div>
                                                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Cari Daftar Tagihan DU Siswa</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i aria-hidden="true" class="ki ki-close"></i>
                </button>
            </div>
            <form class="form" method="POST" action="<?php echo site_url('finance/income/income/search_student_payment_du'); ?>" enctype="multipart/form-data"  id="kt_search_payment">
                <input type="hidden" class="txt_csrfname" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                <div class="modal-body">                   
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="form-group">
                                <label>Nomor Pembayaran DU Siswa</label>
                                <input type="text" name="nomor_pembayaran_du" class="form-control form-control-solid form-control-lg " placeholder="Inputkan Nomor Pembayaran DU Siswa" >
                                <span class="form-text text-dark"><b class="text-danger">*WAJIB DIISI, </b>Inputkan Nomor Pembayaran DU Siswa</span>
                            </div>
                        </div>                      
                    </div>
                </div>
...
<!--end::Content-->
<script src="<?php echo base_url(); ?>assets/finance/dist/assets/js/pages/crud/forms/validation/form-controls-search-payment_du.js">
</script>
