                ...
                <div class="col-lg-12" id="kt_form">
                    ...
                    <div class="card card-custom">
                        <div class="card-header mt-2" style="justify-content: center">
                            <div class="card-title text-center">
                                <h2 class="card-label font-size-h1 font-weight-bolder">
                                    Formulir Tambah Tagihan DU Siswa
                        ...
                        <form class="form" novalidate="novalidate"
                            action="<?php echo site_url('finance/income/income/post_income_du'); ?>"
                            enctype="multipart/form-data" method="post" id="kt_add_income_du_form">
...
?>
                                    ...
                                    <div class="col-lg-1 text-center">
                                        ...
                                        <p class="font-weight-boldest display-3 text-warning text-center">DU</p>
                                    </div>
                                    <div class="col-lg-1">
                                    </div>
                                </div>
...
<script src="<?php echo base_url(); ?>assets/finance/dist/assets/js/pages/custom/login/add-income-du.js"></script>
<script>
