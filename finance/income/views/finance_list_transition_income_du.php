                        ...
                        <div class="card-header pt-4 pb-1" style="justify-content: center">
                            <div class="card-title">
                                <h2 class="card-label font-size-h1 text-center font-weight-bolder text-danger">
                                    KONFIRMASI IMPOR DATA TAGIHAN DU SEKOLAH
                                    <span class="text-dark-75 pt-1 font-size-h6 font-weight-bolder d-block">Berikut
                                        merupakan hasil impor tagihan DU siswa Sekolah Utsman</span>
                                </h2>
                            </div>
                        </div>
                        <div class="card-body">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                    <ul class="nav nav-hover flex-column">
                                                        <li class="nav-item"><a class="nav-link"
                                                                href="<?php echo site_url("/finance/income/detail_income_du/" . paramEncrypt($value->id_tagihan_pembayaran)); ?>"><i
                                                    ...
                                                    <ul class="nav nav-hover flex-column">
                                                        <li class="nav-item"><a
                                                                ...
                                                                class="nav-link edit_income_transition_du text-warning"
                                                    ...
                                                    <ul class="nav nav-hover flex-column">
                                                        <li class="nav-item"><a
                                                                ...
                                                                data-nama="<?php echo $value->nama; ?>"
																data-nominal_tagihan="<?php echo $value->nominal_tagihan; ?>"
                                                                class="nav-link delete_income_transition_du"
                                                                href="javascript:void(0);"><i
...
<!-- Modal Edit DPB  -->
<div class="modal fade" tabindex="" role="dialog" id="modalEditDUTransition">
    <div class="modal-dialog modal-xl" role="document" id="kt_form_du_transition_edit">
        <div class="modal-content">
            <div class="modal-header bg-success">
                <h5 class="modal-title font-weight-bolder">Edit Data Tagihan DU Siswa <b
                        id="nomorInvoiceTagihanEdit"></b></h5>
            ...
            <form class="form needs-validation" method="POST" enctype="multipart/form-data" novalidate="novalidate"
                id="kt_edit_income_du_transaction">
...
<script src="<?php echo base_url(); ?>assets/finance/dist/assets/js/pages/custom/login/income-du-transition.js">
</script>
<script src="<?php echo base_url(); ?>assets/finance/dist/assets/js/pages/custom/login/edit-income-du-transition.js">
</script>
...
function act_confirm_data_payment() {
    ...
    var rows_selected = $("#kt_datatable_income_du_invoice_success").DataTable().column(0).checkboxes.selected();
...
function act_reject_data_payment() {
    ...
    Swal.fire({
        title: "Peringatan!",
        html: "Apakah anda yakin ingin <b>MEMBATALKAN</b> Impor Data Tagihan DU ini?",
        icon: "warning",
        showCancelButton: true,
