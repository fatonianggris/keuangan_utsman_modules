                                                ...
                                                <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                    <ul class="nav nav-hover flex-column">
                                                        <li class="nav-item"><a class="nav-link"
                                                                href="<?php echo site_url("/finance/income/detail_income_du/" . paramEncrypt($value->id_tagihan_pembayaran_du)); ?>"><i
                                                    ...
                                                    <ul class="nav nav-hover flex-column">
                                                        <li class="nav-item"><a class="nav-link text-warning"
                                                                href="<?php echo site_url("/finance/income/edit_income_du/" . paramEncrypt($value->id_tagihan_pembayaran_du)); ?>"><i
...
<div class="modal fade" id="modal_import_payment" tabindex="-1" aria-labelledby="exampleModalSizeLg" aria-hidden="true"
    ...
    <div class="modal-dialog modal-dialog-centered modal-md" role="document" id="kt_modal">
        <div class="modal-content">
            ...
            <form class="form" method="POST" action="<?php echo site_url('finance/income/income/import_du_payment'); ?>"
                enctype="multipart/form-data" id="kt_upload_payment_du">
                <input type="hidden" class="txt_csrfname" name="<?php echo $this->security->get_csrf_token_name(); ?>"
                    value="<?php echo $this->security->get_csrf_hash(); ?>">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="form-group">
                                ...
                                <input type="file" class="dropify_import form-control" name="file_tagihan_du"
...
<script
    src="<?php echo base_url(); ?>assets/finance/dist/assets/js/pages/crud/datatables/search-options/budget-income-du.js">
</script>
<script>
