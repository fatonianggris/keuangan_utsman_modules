                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        <li class="breadcrumb-item text-muted">
                            <a href="" class="text-muted">Daftar Pemasukan DU</a>
                        </li>                       
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="card card-custom mb-8">
                        <div class="card-body py-4 mt-4 mb-3 text-center">
                            <h3 class="card-label text-danger font-weight-boldest">TOTAL BELUM BAYAR</h3>
                            <div class=" flex-lg-grow-1 justify-content-lg-center mt-5 text-center">
                                <p class="font-weight-boldest display-4 mb-1 text-dark-75 text-center">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="card card-custom mb-8">
                        <div class="card-body py-4 mt-4 mb-3 text-center">
                            <h3 class="card-label text-success font-weight-boldest">TOTAL SUDAH BAYAR</h3>
                            <div class=" flex-lg-grow-1 justify-content-lg-center mt-5 text-center">
                                <p class="font-weight-boldest display-4 mb-1 text-dark-75 text-center">
                    ...
                    <div class="card card-custom">
                        <div class="card-header pt-4 pb-1" style="justify-content: center;">
                            ...
                            <div class="card-title">
                                <h2 class="card-label font-size-h2 text-center font-weight-bolder">DAFTAR TAGIHAN DU "<?php echo strtoupper($income[0]->nama); ?>-<?php echo strtoupper($income[0]->nis); ?>"
                                    <span class="text-warning pt-1 font-size-h6 font-weight-normal d-block">Berikut merupakan daftar tagihan DU siswa bersangkutan</span>
                                </h2>
                            </div>
                        ...
                        <div class="card-body">
                                        ...
                                        <form class="mb-6 mt-4">
                                            <div class="row mb-6">
                                                ...
                                                <div class="col-lg-2 mb-lg-0 mb-6">
                                                    ...
                                                    <input type="text" id="kt_datepicker_invoice" readonly="" class="form-control datatable-input" placeholder="Inputkan Tgl Invoice" data-col-index="2" />
                                                </div>
                                                <div class="col-lg-2 mb-lg-0 mb-6">
                            ...
                            <!--begin: Datatable-->
                            <!--begin: Datatable-->
                            <table class="table table-separate table-hover table-light-success table-checkable" id="kt_datatable_income_du">
                                <thead>
                                    <tr>
                                                    ...
                                                    <div class="dropdown dropdown-inline">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                            <ul class="nav nav-hover flex-column">    
                                                                <li class="nav-item"><a class="nav-link" href="<?php echo site_url("/finance/income/detail_income_du/" . paramEncrypt($value->id_tagihan_pembayaran_du)); ?>"><i class="nav-icon fas fa-eye"></i><span class="nav-text text-hover-primary font-weight-bold">Lihat Detail</span></a></li>
                                                            </ul>
                                                            <?php if ($value->status_pembayaran == "MENUNGGU") { ?>
                                                                <ul class="nav nav-hover flex-column">    
                                                                    <li class="nav-item"><a class="nav-link text-warning" href="<?php echo site_url("/finance/income/edit_income_du/" . paramEncrypt($value->id_tagihan_pembayaran_du)); ?>"><i class="nav-icon fas fa-pen text-warning"></i><span class="nav-text text-hover-primary font-weight-bold text-warning">Edit Tagihan</span></a></li>
                                                                </ul>   
                                                                <ul class="nav nav-hover flex-column">    
                                                                    <li class="nav-item"><a class="nav-link" href="javascript:act_delete_income('<?php echo paramEncrypt($value->id_tagihan_pembayaran_du); ?>', '<?php echo paramEncrypt($value->id_tagihan_pembayaran_du); ?>', '<?php echo strtoupper(preg_replace('/[^A-Za-z0-9\-]/', ' ', $value->nama_lengkap)); ?>', '<?php echo strtoupper($value->nis); ?>')"><i class="nav-icon fas fa-trash text-danger"></i><span class="nav-text text-danger font-weight-bold text-hover-primary">Hapus Tagihan</span></a></li>
                                                                </ul> 
                                                            <?php } ?> 
                                                        </div>
                                                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Cari Daftar Tagihan Siswa</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i aria-hidden="true" class="ki ki-close"></i>
                </button>
            </div>
            <form class="form" method="POST" action="<?php echo site_url('finance/income/income/search_student_payment'); ?>" enctype="multipart/form-data"  id="kt_search_payment">
                <input type="hidden" class="txt_csrfname" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="cari_siswa" class="form-control form-control-solid form-control-lg " placeholder="Inputkan NIS/Nama Siswa" >
                                <span class="form-text text-dark"><b class="text-danger">*WAJIB DIISI, </b>Inputkan NIS/Nama Siswa</span>
                            </div>
                        </div>                      
                    </div>
                </div>
...
<div class="modal fade" id="modal_import_payment" tabindex="-1" aria-labelledby="exampleModalSizeLg" aria-hidden="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-md" role="document" id="kt_modal">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Import Tagihan Siswa DU</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i aria-hidden="true" class="ki ki-close"></i>
                </button>
            </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="form-group">
                                ...
                                <input type="file" class="dropify_import form-control" name="file_tagihan_du" data-max-file-size="10M" data-height="200" data-allowed-file-extensions="xls xlsx" />
...
<!--end::Content-->
<script src="<?php echo base_url(); ?>assets/finance/dist/assets/js/pages/crud/forms/validation/form-controls-search-payment.js">
</script>
<script src="<?php echo base_url(); ?>assets/finance/dist/assets/js/pages/crud/datatables/search-options/budget-income-du.js">
</script>
<script>
