				...
				<div class="col-lg-12">
					...
					<div class="card card-custom">
						...
						<div class="card-body">
												...
												<div class="col-lg-2 mb-lg-0 mb-6">
													...
													<select class="form-control datatable-input" data-col-index="11">
														...
														foreach ($months as $key => $value) {
															if ($i == $num_month) { ?>
																<option value="<?php echo $i; ?>" selected><?php echo $value; ?></option>
															<?php } else { ?>
							...
							<!--begin: Datatable-->
							<table class="table table-separate table-hover table-light-primary table-checkable" id="kt_datatable_income_dpb">
								<thead>
									<tr>
...
<script src="<?php echo base_url(); ?>assets/finance/dist/assets/js/pages/crud/datatables/search-options/budget-income-dpb-server.js">
</script>
<script>
