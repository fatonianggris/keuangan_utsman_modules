					...
					<div class="card card-custom">
						<div class="card-header pt-4 pb-1" style="justify-content: center;">
							...
							<div class="card-title">
								<h2 class="card-label font-size-h2 text-center font-weight-bolder">DAFTAR TAGIHAN DPB "<?php echo strtoupper($income[0]->nama); ?>-<?php echo strtoupper($income[0]->nis); ?>"
									<span class="text-warning pt-1 font-size-h6 font-weight-normal d-block">Berikut merupakan daftar tagihan DPB siswa bersangkutan</span>
								</h2>
							</div>
												...
												<div class="col-lg-2 text-right">
													<div class="btn-group">
														...
														<div class="dropdown-menu">
															<form class="form" id="frm-excel" action="<?php echo site_url('//'); ?>" method="POST">
															...
															<form class="form" id="frm-form" action="<?php echo site_url('//'); ?>" method="POST">
													...
													<div class="dropdown dropdown-inline">
														...
														<div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
															...
															<?php if ($value->status_pembayaran == "MENUNGGU") { ?>
																...
																<ul class="nav nav-hover flex-column">
																	<li class="nav-item"><a class="nav-link" href="javascript:act_delete_income('<?php echo paramEncrypt($value->id_tagihan_pembayaran_dpb); ?>', '<?php echo strtoupper(preg_replace('/[^A-Za-z0-9\-]/', ' ', $value->nama_lengkap)); ?>', '<?php echo strtoupper($value->nis); ?>')"><i class="nav-icon fas fa-trash text-danger"></i><span class="nav-text text-danger font-weight-bold text-hover-primary">Hapus Tagihan</span></a></li>
																</ul>
															<?php } ?>
...
<div class="modal fade" id="modal_import_payment" tabindex="-1" aria-labelledby="exampleModalSizeLg" aria-hidden="true" role="dialog">
	<div class="modal-dialog modal-dialog-centered modal-md" role="document" id="kt_modal">
		<div class="modal-content">
			...
			<form class="form" method="POST" action="<?php echo site_url('finance/income/income/import_dpb_payment'); ?>" enctype="multipart/form-data" id="kt_upload_payment">
				<input type="hidden" class="txt_csrfname" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
				<div class="modal-body">
					<div class="row">
						<div class="col-xl-12">
