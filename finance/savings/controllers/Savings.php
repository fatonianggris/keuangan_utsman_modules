...
class Savings extends MX_Controller
{
    ...
    public function list_employee_saving()
    {
        $data['nav_save']   = 'menu-item-here';
        $data['structure']  = $this->SavingsModel->get_structure_account();
        $data['schoolyear'] = $this->SavingsModel->get_schoolyear();
        ...
        if (! empty($this->user_finance) && in_array($this->user_finance[0]->id_role_struktur, $this->allowed_roles)) {
            $this->template->load('template_finance/template_finance', 'finance_employee_savings_view_all', $data);
        } else {
            $datas['title'] = 'ERROR | PAGE NOT FOUND';
            $this->load->view('error_404', $datas);
        }
    ...
    public function saving_qurban_transaction_employee()
    {
        $data['nav_save']   = 'menu-item-here';
        $data['structure']  = $this->SavingsModel->get_structure_account();
        $data['schoolyear'] = $this->SavingsModel->get_schoolyear();
        ...
        if (! empty($this->user_finance) && in_array($this->user_finance[0]->id_role_struktur, $this->allowed_roles)) {
            $this->template->load('template_finance/template_finance', 'finance_savings_qurban_transaction_employee', $data);
        } else {
            $datas['title'] = 'ERROR | PAGE NOT FOUND';
            $this->load->view('error_404', $datas);
        }
    ...
    public function saving_tht_transaction_employee()
    {
        $data['nav_save']   = 'menu-item-here';
        $data['structure']  = $this->SavingsModel->get_structure_account();
        $data['schoolyear'] = $this->SavingsModel->get_schoolyear();
        ...
        if (! empty($this->user_finance) && in_array($this->user_finance[0]->id_role_struktur, $this->allowed_roles)) {
            $this->template->load('template_finance/template_finance', 'finance_savings_tht_transaction_employee', $data);
        } else {
            $datas['title'] = 'ERROR | PAGE NOT FOUND';
            $this->load->view('error_404', $datas);
        }
    ...
    public function check_number_employee_saving()
    {
        ...
        $check = $this->SavingsModel->get_number_employee_saving($number);
    ...
    public function check_number_import_employee_saving()
    {
        ...
        if ($check) {
            ...
            $check_import = $this->SavingsModel->get_number_import_employee_saving($number);
    ...
    public function check_name_import_employee_saving()
    {
        ...
        $name  = preg_replace("/['\"-]/", "", $name);
        $check = $this->SavingsModel->check_employee_by_name_and_number($number, strtoupper($name));
        ...
        if ($check) {
            ...
            $check_transition = $this->SavingsModel->get_number_name_import_employee_saving($number, strtoupper($name));
    ...
    public function add_employee_saving()
    {
        $data['nav_save']   = 'menu-item-here';
        $data['structure']  = $this->SavingsModel->get_structure_account();
        $data['schoolyear'] = $this->SavingsModel->get_schoolyear();
    ...
    public function get_all_student_or_employee()
    {
        $param = $this->input->get();
        $get   = $this->security->xss_clean($param);

        if ($get['jenis_tabungan'] != '' && $get['jenis_tabungan'] != null) {

            if ($get['jenis_tabungan'] == "2") {
                $data = $this->SavingsModel->get_employee();
            } else {
                $data = $this->SavingsModel->get_student();
            }

        } else {
            $data = ['number' => 0, 'nama_lengkap' => 'TIDAK DITEMUKAN'];
        }
    ...
    public function get_all_permanent_employee()
    {
        $data = $this->SavingsModel->get_permanent_employee();
    ...
    {
        $data['data_pegawai'] = $this->SavingsModel->get_employee_by_nip($id);
    ...
    public function get_all_employee_customer()
    {
        $param = $this->input->get();
        $get   = $this->security->xss_clean($param);

        $data = $this->SavingsModel->get_all_employee_customer($get['start_date'], $get['end_date']);
    ...
    {
        $data = $this->SavingsModel->get_all_import_employee_customer();
    ...
    public function get_all_transaction_employee()
    {
        ...
        $data = $this->SavingsModel->get_all_general_transaction_savings_employee($get['start_date'], $get['end_date']);
    ...
    public function get_all_qurban_transaction_employee()
    {
        $param = $this->input->get();
        $get   = $this->security->xss_clean($param);

        $data = $this->SavingsModel->get_all_qurban_transaction_savings_employee($get['start_date'], $get['end_date']);
    ...
    public function get_all_tht_transaction_employee()
    {
        $param = $this->input->get();
        $get   = $this->security->xss_clean($param);

        $data = $this->SavingsModel->get_all_tht_transaction_savings_employee($get['start_date'], $get['end_date']);
    ...
    public function get_employee_recap_transaction($nip = '')
    {
        ...
        $data = $this->SavingsModel->get_employee_transaction_recap_by_nip($nip, $get['start_date'], $get['end_date']); //?
    ...
    {
        $data['info_pegawai']  = $this->SavingsModel->get_employee_by_nip($nip);
        $data['info_tabungan'] = $this->SavingsModel->get_info_employee_transaction($nip);
    ...
    public function get_employee_qurban_info($nip = '')
    {
        $data['info_pegawai']  = $this->SavingsModel->get_employee_by_nip($nip);
        $data['info_tabungan'] = $this->SavingsModel->get_info_employee_transaction_qurban($nip);
    ...
    public function get_employee_tht_info($nip = '')
    {
        $data['info_pegawai']  = $this->SavingsModel->get_employee_by_nip($nip);
        $data['info_tabungan'] = $this->SavingsModel->get_info_employee_transaction_tht($nip);
    ...
    {
        $data['info_pegawai']         = $this->SavingsModel->get_employee_by_nip($nip);
        $data['info_tabungan_umum']   = $this->SavingsModel->get_info_employee_transaction($nip);
        $data['info_tabungan_qurban'] = $this->SavingsModel->get_info_employee_transaction_qurban($nip);
        $data['info_tabungan_tht']    = $this->SavingsModel->get_info_employee_transaction_tht($nip);
    ...
    public function recap_employee_transaction($nip = '')
    {
        ...
        $data['schoolyear']     = $this->SavingsModel->get_schoolyear();
        $data['info_pegawai']   = $this->SavingsModel->get_employee_by_nip($nip);
        $data['info_transaksi'] = $this->SavingsModel->get_info_employee_transaction($nip);
            ...
            if (empty($check_number)) {
                ...
                if ($input_bank_customer == true) {
                    ...
                    if ($data['input_saldo_tabungan_wisata'] >= 1000) {
                        ...
                        $data_wisata = [
                            'nomor_transaksi_tht' => "TW01/" . $random_number . "/" . date('YmdHis'),
                            'id_tingkat'          => $data['input_tingkat'],
                            'nis'                 => $data['input_nomor_rekening'],
    ...
    public function post_employee_savings()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $check_number = $this->SavingsModel->get_number_employee_saving($data['input_nomor_rekening']);

            if (empty($check_number)) {

                $input_bank_customer = $this->SavingsModel->insert_employee_saving($data);
                ...
                if ($input_bank_customer == true) {
                    ...
                    if ($data['input_saldo_tabungan_umum'] >= 1000) {
                        ...
                        $input_umum = $this->SavingsModel->insert_credit_saving_employee($this->user_finance[0]->id_akun_keuangan, $data_umum);
    ...
    public function post_joint_savings()
    {
        ...
        $this->form_validation->set_rules('input_nominal_saldo', 'Nominal Saldo', 'required');
        $this->form_validation->set_rules('input_tahun_ajaran', 'Tahun Ajaran', 'required');
        $this->form_validation->set_rules('input_tingkat', 'Tingkat Tabungan', 'required');
        $this->form_validation->set_rules('input_jenis_tabungan', 'Jenis Tabungan Bersama', 'required');
        $this->form_validation->set_rules('input_tanggal_transaksi', 'Tanggal Transaksi', 'required');
        $this->form_validation->set_rules('input_nama_penanggungjawab', 'Nama Penanggung Jawab', 'required');
        ...
        if ($this->form_validation->run() == false) {
            ...
            if (empty($check_number)) {
                ...
                if ($input == true) {
                    ...
                    if ($data['input_jenis_tabungan'] == 1) {
                        $check_number = $this->SavingsModel->get_student_nis($data['input_nama_penanggungjawab']);
                        if ($check_number) {
                            $this->SavingsModel->update_name_and_hp_parent($data['input_nama_penanggungjawab'], $data);
                        }
                    } else {
                        $check_number = $this->SavingsModel->get_employee_nip($data['input_nama_penanggungjawab']);
                        if ($check_number) {
                            $this->SavingsModel->update_hp_employee($data['input_nama_penanggungjawab'], $data);
                        }
                    }
                    ...
                    if ($data['input_nominal_saldo'] != "" or $data['input_nominal_saldo'] >= 1000 or $data['input_nominal_saldo'] != null) {
                        ...
                        $transaksi_bersama = "<b>->TRANSAKSI DI TABUNGAN BERSAMA SEBESAR Rp. $data[input_nominal_saldo], STATUS:</b> <b class='text-danger'>GAGAL</b> <b>(NOMINAL TIDAK BOLEH KURANG DARI 1000)</b><br>";
                    }

                    $trans_msg = ["nama_tabungan" => strtoupper($data['input_nama_tabungan_bersama']),
    ...
    public function update_employee_saving()
    {
        ...
        if (! empty($this->user_finance) && in_array($this->user_finance[0]->id_role_struktur, $this->allowed_roles)) {
            ...
            if ($data['id_pegawai'] == "" or empty($data['id_pegawai']) or $data['id_pegawai'] == null) {
                ...
                $update_employee = $this->SavingsModel->update_employee_saving($data['id_pegawai'], $data);
    ...
    public function update_joint_saving()
    {
        ...
        if (! empty($this->user_finance) && in_array($this->user_finance[0]->id_role_struktur, $this->allowed_roles)) {
            ...
            if ($data['id_tabungan_bersama'] == "" or empty($data['id_tabungan_bersama']) or $data['id_tabungan_bersama'] == null) {
                ...
                $update_personal = $this->SavingsModel->update_name_hp_customer($data['id_penanggung_jawab'], $data);
    ...
    public function post_credit_employee()
    {
        ...
        $get_balance                  = $this->SavingsModel->get_employee_balance($data['nip']);
        ...
        if (! empty($this->user_finance) && in_array($this->user_finance[0]->id_role_struktur, $this->allowed_roles)) {
            ...
            if ($data == false or empty($data['nip'])) {
                ...
                if (password_verify($data['pin_verification_kredit'], $check_pin[0]->pin_akun)) {
                    ...
                    $input_credit   = $this->SavingsModel->insert_credit_saving_employee($this->user_finance[0]->id_akun_keuangan, $data);
                    $update_balance = $this->SavingsModel->update_balance_saving_employee($data['nip'], $data['saldo_akhir']);
    ...
    public function post_qurban_credit_employee()
    {
        $param = $this->input->post();
        $data  = $this->security->xss_clean($param);
        ...
        $random_number                  = str_pad(rand(0, pow(10, 2) - 1), 2, '0', STR_PAD_LEFT);
        $data['status_kredit_debet']    = "1";
        $data['nomor_transaksi_qurban'] = "TPQ01" . $random_number . "/" . date('YmdHis');
        $get_balance                    = $this->SavingsModel->get_employee_balance($data['nip']);
        ...
        if (! empty($this->user_finance) && in_array($this->user_finance[0]->id_role_struktur, $this->allowed_roles)) {
            ...
            if ($data == false or empty($data['nip'])) {
                ...
                if (password_verify($data['pin_verification_kredit'], $check_pin[0]->pin_akun)) {
                    ...
                    $input_credit   = $this->SavingsModel->insert_qurban_credit_saving_employee($this->user_finance[0]->id_akun_keuangan, $data);
                    $update_balance = $this->SavingsModel->update_qurban_balance_saving_employee($data['nip'], $data['saldo_akhir']);
                    ...
                    if ($input_credit['status'] == true && $update_balance == true) {
                        ...
                        $output = ["status" => true,
                            ...
                            "waktu_transaksi"   => date('d/m/Y H:i:s', strtotime($input_credit['data']->waktu_transaksi)),
                            "saldo_akhir"       => $input_credit['data']->saldo,
                            "messages"          => "Berhasil Disetor!, Setor Tabungan Qurban Pegawai Atas Nama <b>" . $get_balance[0]->nama_lengkap . " (" . $get_balance[0]->nip . ")</b> telah ditambahkan. Silahkan cek Rekap/Histori Tabungan di Menu Daftar Tabungan Qurban Pegawai.",
                        ];
    ...
    public function post_tht_credit_employee()
    {
        $param = $this->input->post();
        $data  = $this->security->xss_clean($param);
        ...
        $random_number               = str_pad(rand(0, pow(10, 2) - 1), 2, '0', STR_PAD_LEFT);
        $data['status_kredit_debet'] = "1";
        $data['nomor_transaksi_tht'] = "TPT01" . $random_number . "/" . date('YmdHis');
        $get_balance                 = $this->SavingsModel->get_employee_balance($data['nip']);
        ...
        if (! empty($this->user_finance) && in_array($this->user_finance[0]->id_role_struktur, $this->allowed_roles)) {
            ...
            if ($data == false or empty($data['nip'])) {
                ...
                if (password_verify($data['pin_verification_kredit'], $check_pin[0]->pin_akun)) {
                    ...
                    if ($get_balance[0]->saldo_tabungan_tht == 0) {
                        ...
                        $data['saldo_akhir'] = $data['nominal'] + $get_balance[0]->saldo_tabungan_tht;

                    }

                    $input_credit   = $this->SavingsModel->insert_tht_credit_saving_employee($this->user_finance[0]->id_akun_keuangan, $data);
                    $update_balance = $this->SavingsModel->update_tht_balance_saving_employee($data['nip'], $data['saldo_akhir']);

                    if ($input_credit['status'] == true && $update_balance == true) {

                        $output = ["status" => true,
                            "token"             => $token,
                            "nomor_transaksi"   => $input_credit['data']->nomor_transaksi_tht,
                            "waktu_transaksi"   => date('d/m/Y H:i:s', strtotime($input_credit['data']->waktu_transaksi)),
                            "saldo_akhir"       => $input_credit['data']->saldo,
                            "messages"          => "Berhasil Disetor!, Setor Tabungan Wisata Pegawai Atas Nama <b>" . $get_balance[0]->nama_lengkap . " (" . $get_balance[0]->nip . ")</b> telah ditambahkan. Silahkan cek Rekap/Histori Tabungan di Menu Daftar Tabungan Wisata Pegawai.",
                        ];
    ...
    public function post_credit_new_client_employee()
    {
        $param = $this->input->post();
        $data  = $this->security->xss_clean($param);
        ...
        if (! empty($this->user_finance) && in_array($this->user_finance[0]->id_role_struktur, $this->allowed_roles)) {
            ...
            if ($data == false or empty($data['nip'])) {
                ...
                if (password_verify($data['pin_verification_kredit'], $check_pin[0]->pin_akun)) {
                    ...
                    $input_client = $this->SavingsModel->insert_client_employee($data);
                    $input_credit = $this->SavingsModel->insert_credit_saving_employee($this->user_finance[0]->id_akun_keuangan, $data);
                    ...
                    if ($input_client == true && $input_credit['status'] == true) {
                        ...
                        $output = ["status" => true,
                            ...
                            "waktu_transaksi"   => date('d/m/Y H:i:s', strtotime($input_credit['data']->waktu_transaksi)),
                            "saldo_akhir"       => $input_credit['data']->saldo,
                            "messages"          => "Berhasil Disetor!, Setor Tabungan Umum Pegawai Atas Nama <b>" . $data['nama_nasabah'] . " (" . $data['nip'] . ")</b> telah ditambahkan. Silahkan cek Rekap/Histori Tabungan di Menu Daftar Tabungan Umum Pegawai.",
                        ];
    ...
    public function post_qurban_credit_new_client_employee()
    {
        $param = $this->input->post();
        $data  = $this->security->xss_clean($param);
        ...
        if (! empty($this->user_finance) && in_array($this->user_finance[0]->id_role_struktur, $this->allowed_roles)) {
            ...
            if ($data == false or empty($data['nip'])) {
                ...
                if (password_verify($data['pin_verification_kredit'], $check_pin[0]->pin_akun)) {
                    ...
                    $input_client = $this->SavingsModel->insert_qurban_client_employee($data);
                    $input_credit = $this->SavingsModel->insert_qurban_credit_saving_employee($this->user_finance[0]->id_akun_keuangan, $data);
                    ...
                    if ($input_client == true && $input_credit['status'] == true) {
                        ...
                        $output = ["status" => true,
                            ...
                            "waktu_transaksi"   => date('d/m/Y H:i:s', strtotime($input_credit['data']->waktu_transaksi)),
                            "saldo_akhir"       => $input_credit['data']->saldo,
                            "messages"          => "Berhasil Disetor!, Setor Tabungan Qurban Pegawai Atas Nama <b>" . $data['nama_nasabah'] . " (" . $data['nip'] . ")</b> telah ditambahkan. Silahkan cek Rekap/Histori Tabungan di Menu Daftar Tabungan Qurban Pegawai.",
                        ];
    ...
    public function post_tht_credit_new_client_employee()
    {
        $param = $this->input->post();
        $data  = $this->security->xss_clean($param);
        ...
        if (! empty($this->user_finance) && in_array($this->user_finance[0]->id_role_struktur, $this->allowed_roles)) {
            ...
            if ($data == false or empty($data['nip'])) {
                ...
                if (password_verify($data['pin_verification_kredit'], $check_pin[0]->pin_akun)) {
                    ...
                    $input_client = $this->SavingsModel->insert_tht_client_employee($data);
                    $input_credit = $this->SavingsModel->insert_tht_credit_saving_employee($this->user_finance[0]->id_akun_keuangan, $data);
                    ...
                    if ($input_client == true && $input_credit['status'] == true) {
                        ...
                        $output = ["status" => true,
                            ...
                            "waktu_transaksi"   => date('d/m/Y H:i:s', strtotime($input_credit['data']->waktu_transaksi)),
                            "saldo_akhir"       => $input_credit['data']->saldo,
                            "messages"          => "Berhasil Disetor!, Setor Tabungan Wisata Pegawai Atas Nama <b>" . $data['nama_nasabah'] . " (" . $data['nip'] . ")</b> telah ditambahkan. Silahkan cek Rekap/Histori Tabungan di Menu Daftar Tabungan Wisata Pegawai.",
                        ];
    ...
    public function update_credit_employee()
    {
        ...
        $get_transaction = $this->SavingsModel->get_employee_transaction_last($data['id_transaksi']);
        $get_balance     = $this->SavingsModel->get_employee_balance($data['nip']);
        ...
        if (! empty($this->user_finance) && in_array($this->user_finance[0]->id_role_struktur, $this->allowed_roles)) {
            ...
            if ($data == false or empty($data['nip']) or empty($data['id_transaksi'])) {
                ...
                if (password_verify($data['pin_verification_kredit_edit'], $check_pin[0]->pin_akun)) {
                    ...
                    $update_credit  = $this->SavingsModel->update_credit_saving_employee($data['id_transaksi'], $data);
                    $update_balance = $this->SavingsModel->update_balance_saving_employee($data['nip'], $data['saldo_akhir']);
    ...
    public function update_qurban_credit_employee()
    {
        $param = $this->input->post();
        $data  = $this->security->xss_clean($param);

        $get_transaction = $this->SavingsModel->get_employee_transaction_qurban_last($data['id_transaksi']);
        $get_balance     = $this->SavingsModel->get_employee_balance($data['nip']);
        ...
        if (! empty($this->user_finance) && in_array($this->user_finance[0]->id_role_struktur, $this->allowed_roles)) {
            ...
            if ($data == false or empty($data['nip']) or empty($data['id_transaksi'])) {
                ...
                if (password_verify($data['pin_verification_kredit_edit'], $check_pin[0]->pin_akun)) {
                    ...
                    $update_credit  = $this->SavingsModel->update_qurban_credit_saving_employee($data['id_transaksi'], $data);
                    $update_balance = $this->SavingsModel->update_qurban_balance_saving_employee($data['nip'], $data['saldo_akhir']);
                    ...
                    if ($update_credit == true && $update_balance == true) {
                        ...
                        $output = ["status" => true,
                            ...
                            "waktu_transaksi"   => date('d/m/Y H:i:s', strtotime($get_transaction[0]->waktu_transaksi)),
                            "saldo_akhir"       => $data['saldo_akhir'],
                            "messages"          => "Berhasil Diubah!, Perubahan Setor Tabungan Qurban Pegawai Atas Nama <b>" . $get_balance[0]->nama_lengkap . " (" . $get_balance[0]->nip . ")</b> telah diubah. Silahkan cek Rekap/Histori Tabungan di Menu Daftar Tabungan Qurban Pegawai.",
                        ];
    ...
    public function update_tht_credit_employee()
    {
        $param = $this->input->post();
        $data  = $this->security->xss_clean($param);

        $get_transaction = $this->SavingsModel->get_employee_transaction_tht_last($data['id_transaksi']);
        $get_balance     = $this->SavingsModel->get_employee_balance($data['nip']);
        ...
        if (! empty($this->user_finance) && in_array($this->user_finance[0]->id_role_struktur, $this->allowed_roles)) {
            ...
            if ($data == false or empty($data['nip']) or empty($data['id_transaksi'])) {
                ...
                if (password_verify($data['pin_verification_kredit_edit'], $check_pin[0]->pin_akun)) {
                    ...
                    if (($get_balance[0]->saldo_tabungan_tht - $get_transaction[0]->nominal) == 0) {
                        ...
                        $data['saldo_akhir'] = $data['nominal'] + ($get_balance[0]->saldo_tabungan_tht - $get_transaction[0]->nominal);

                    }

                    $update_credit  = $this->SavingsModel->update_tht_credit_saving_employee($data['id_transaksi'], $data);
                    $update_balance = $this->SavingsModel->update_tht_balance_saving_employee($data['nip'], $data['saldo_akhir']);
                    ...
                    if ($update_credit == true && $update_balance == true) {
                        ...
                        $output = ["status" => true,
                            "token"             => $token,
                            "nomor_transaksi"   => $get_transaction[0]->nomor_transaksi_tht,
                            "waktu_transaksi"   => date('d/m/Y H:i:s', strtotime($get_transaction[0]->waktu_transaksi)),
                            "saldo_akhir"       => $data['saldo_akhir'],
                            "messages"          => "Berhasil Diubah!, Perubahan Setor Tabungan Wisata Pegawai Atas Nama <b>" . $get_balance[0]->nama_lengkap . " (" . $get_balance[0]->nip . ")</b> telah diubah. Silahkan cek Rekap/Histori Tabungan di Menu Daftar Tabungan Wisata Pegawai.",
                        ];
            ...
            if ($data == false or empty($data['nip'])) {
                ...
                if (password_verify($data['pin_verification_debet'], $check_pin[0]->pin_akun)) {
                    ...
                    if (($get_balance[0]->saldo_tabungan_umum > 0) && ($data['nominal'] <= $get_balance[0]->saldo_tabungan_umum)) {
                        ...
                        $input_debet    = $this->SavingsModel->insert_debet_saving_employee($this->user_finance[0]->id_akun_keuangan, $data);
                        $update_balance = $this->SavingsModel->update_balance_saving_employee($data['nip'], $data['saldo_akhir']);
    ...
    public function post_qurban_debet_employee()
    {
        $param = $this->input->post();
        $data  = $this->security->xss_clean($param);
        ...
        $data['jenis_tabungan']         = "2";
        $data['status_kredit_debet']    = "2";
        $data['nomor_transaksi_qurban'] = "TPQ02" . $random_number . "/" . date('YmdHis');
        $get_balance                    = $this->SavingsModel->get_employee_balance($data['nip']);
            ...
            if ($data == false or empty($data['nip'])) {
                ...
                if (password_verify($data['pin_verification_debet'], $check_pin[0]->pin_akun)) {
                    ...
                    if (($get_balance[0]->saldo_tabungan_qurban > 0) && ($data['nominal'] <= $get_balance[0]->saldo_tabungan_qurban)) {
                        ...
                        $input_debet    = $this->SavingsModel->insert_qurban_debet_saving_employee($this->user_finance[0]->id_akun_keuangan, $data);
                        $update_balance = $this->SavingsModel->update_qurban_balance_saving_employee($data['nip'], $data['saldo_akhir']);
                        ...
                        if ($input_debet['status'] == true && $update_balance == true) {
                            ...
                            $output = ["status" => true,
                                ...
                                "waktu_transaksi"   => date('d/m/Y H:i:s', strtotime($input_debet['data']->waktu_transaksi)),
                                "saldo_akhir"       => $input_debet['data']->saldo,
                                "messages"          => "Berhasil Ditarik!, Penarikan Tabungan Qurban Pegawai Atas Nama <b>" . $get_balance[0]->nama_lengkap . " (" . $get_balance[0]->nip . ")</b> telah ditarik. Silahkan cek Rekap/Histori Tabungan di Menu Daftar Tabungan Qurban Pegawai.",
                            ];
    ...
    public function post_tht_debet_employee()
    {
        $param = $this->input->post();
        $data  = $this->security->xss_clean($param);
        ...
        $data['jenis_tabungan']      = "3";
        $data['status_kredit_debet'] = "2";
        $data['nomor_transaksi_tht'] = "TPW02" . $random_number . "/" . date('YmdHis');
        $get_balance                 = $this->SavingsModel->get_employee_balance($data['nip']);
        ...
        if (! empty($this->user_finance) && in_array($this->user_finance[0]->id_role_struktur, $this->allowed_roles)) {
            ...
            if ($data == false or empty($data['nip'])) {
                ...
                if (password_verify($data['pin_verification_debet'], $check_pin[0]->pin_akun)) {
                    ...
                    if (($get_balance[0]->saldo_tabungan_tht > 0) && ($data['nominal'] <= $get_balance[0]->saldo_tabungan_tht)) {

                        $data['saldo_akhir'] = $get_balance[0]->saldo_tabungan_tht - $data['nominal'];

                        $input_debet    = $this->SavingsModel->insert_tht_debet_saving_employee($this->user_finance[0]->id_akun_keuangan, $data);
                        $update_balance = $this->SavingsModel->update_tht_balance_saving_employee($data['nip'], $data['saldo_akhir']);
                        ...
                        if ($input_debet['status'] == true && $update_balance == true) {
                            ...
                            $output = ["status" => true,
                                "token"             => $token,
                                "nomor_transaksi"   => $input_debet['data']->nomor_transaksi_tht,
                                "waktu_transaksi"   => date('d/m/Y H:i:s', strtotime($input_debet['data']->waktu_transaksi)),
                                "saldo_akhir"       => $input_debet['data']->saldo,
                                "messages"          => "Berhasil Ditarik!, Penarikan Tabungan Wisata Pegawai Atas Nama <b>" . $get_balance[0]->nama_lengkap . " (" . $get_balance[0]->nip . ")</b> telah ditarik. Silahkan cek Rekap/Histori Tabungan di Menu Daftar Tabungan Wisata Pegawai.",
                            ];
                    ...
                    } else if (($get_balance[0]->saldo_tabungan_tht <= 0)) {
                    ...
                    } else if (($data['nominal'] > $get_balance[0]->saldo_tabungan_tht)) {
                        $output = ["status" => false,
                            "token"             => $token,
                            "messages"          => "Opps!, Inputan Penarikan Tidak Boleh Lebih dari Saldo Tabungan, Silahkan input ulang.",
                        ];
            ...
            if ($data == false or empty($data['nip']) or empty($data['id_transaksi'])) {
                ...
                if (password_verify($data['pin_verification_debet_edit'], $check_pin[0]->pin_akun)) {
                    ...
                    if ((($get_transaction[0]->saldo + $get_transaction[0]->nominal) > 0) && ($data['nominal'] <= ($get_transaction[0]->saldo + $get_transaction[0]->nominal))) {
                        ...
                        $update_debet   = $this->SavingsModel->update_debet_saving_employee($data['id_transaksi'], $data);
                        $update_balance = $this->SavingsModel->update_balance_saving_employee($data['nip'], $data['saldo_akhir']);
    ...
    public function update_qurban_debet_employee()
    {
        $param = $this->input->post();
        $data  = $this->security->xss_clean($param);
            ...
            if ($data == false or empty($data['nip']) or empty($data['id_transaksi'])) {
                ...
                if (password_verify($data['pin_verification_debet_edit'], $check_pin[0]->pin_akun)) {
                    ...
                    if ((($get_transaction[0]->saldo + $get_transaction[0]->nominal) > 0) && ($data['nominal'] <= ($get_transaction[0]->saldo + $get_transaction[0]->nominal))) {
                        ...
                        $update_debet   = $this->SavingsModel->update_qurban_debet_saving_employee($data['id_transaksi'], $data);
                        $update_balance = $this->SavingsModel->update_qurban_balance_saving_employee($data['nip'], $data['saldo_akhir']);
                        ...
                        if ($update_debet == true && $update_balance == true) {
                            ...
                            $output = ["status" => true,
                                ...
                                "waktu_transaksi"   => date('d/m/Y H:i:s', strtotime($get_transaction[0]->waktu_transaksi)),
                                "saldo_akhir"       => $data['saldo_akhir'],
                                "messages"          => "Berhasil Diubah!, Perubahan Penarikan Tabungan Qurban Pegawai Atas Nama <b>" . $get_balance[0]->nama_lengkap . " (" . $get_balance[0]->nip . ")</b> telah diubah. Silahkan cek Rekap/Histori Tabungan di Menu Daftar Tabungan Qurban Pegawai.",
                            ];
    ...
    public function update_tht_debet_employee()
    {
        $param = $this->input->post();
        $data  = $this->security->xss_clean($param);
            ...
            if ($data == false or empty($data['nip']) or empty($data['id_transaksi'])) {
                ...
                if (password_verify($data['pin_verification_debet_edit'], $check_pin[0]->pin_akun)) {
                    ...
                    if ((($get_transaction[0]->saldo + $get_transaction[0]->nominal) > 0) && ($data['nominal'] <= ($get_transaction[0]->saldo + $get_transaction[0]->nominal))) {
                        ...
                        $update_debet   = $this->SavingsModel->update_tht_debet_saving_employee($data['id_transaksi'], $data);
                        $update_balance = $this->SavingsModel->update_tht_balance_saving_employee($data['nip'], $data['saldo_akhir']);
                        ...
                        if ($update_debet == true && $update_balance == true) {
                            ...
                            $output = ["status" => true,
                                ...
                                "waktu_transaksi"   => date('d/m/Y H:i:s', strtotime($get_transaction[0]->waktu_transaksi)),
                                "saldo_akhir"       => $data['saldo_akhir'],
                                "messages"          => "Berhasil Diubah!, Perubahan Penarikan Tabungan Wisata Pegawai Atas Nama <b>" . $get_balance[0]->nama_lengkap . " (" . $get_balance[0]->nip . ")</b> telah diubah. Silahkan cek Rekap/Histori Tabungan di Menu Daftar Tabungan Wisata Pegawai.",
                            ];
                ...
                if (password_verify($data['password'], $check_pass[0]->password)) {
                    ...
                    if ($get_transaction == true && $get_balance == true) {
                        ...
                        if ($update_balance == true && $delete == true) {
                            ...
                            $output = ["status" => true,
                                "token"             => $token,
                                "messages"          => "Berhasil Dihapus!, Kredit Tabungan Bersama <b>" . $data['nomor_transaksi_bersama'] . "</b> Atas Nama <b>" . $get_balance[0]->nama_tabungan_bersama . " (" . $get_balance[0]->nomor_rekening_bersama . ")</b> telah dihapus. Silahkan cek Rekap/Histori Tabungan menu Daftar Tabungan Bersama.",
                            ];
                        } else {
            ...
            if ($data['nip'] && $data['id_transaksi'] && $data['nomor_transaksi'] && $data['password']) {
                ...
                if (password_verify($data['password'], $check_pass[0]->password)) {
                    ...
                    if ($get_transaction == true && $get_balance == true) {
                        ...
                        $update_balance = $this->SavingsModel->update_balance_saving_employee($data['nip'], $data['saldo_akhir']);
                        $delete         = $this->SavingsModel->delete_transaction_employee($data['id_transaksi']);
    ...
    public function delete_qurban_credit_transaction_employee()
    {
        $param = $this->input->post();
        $data  = $this->security->xss_clean($param);
            ...
            if ($data['nip'] && $data['id_transaksi'] && $data['nomor_transaksi'] && $data['password']) {
                ...
                if (password_verify($data['password'], $check_pass[0]->password)) {
                    ...
                    if ($get_transaction == true && $get_balance == true) {
                        ...
                        $update_balance = $this->SavingsModel->update_qurban_balance_saving_employee($data['nip'], $data['saldo_akhir']);
                        $delete         = $this->SavingsModel->delete_qurban_transaction_employee($data['id_transaksi']);

                        if ($update_balance == true && $delete == true) {

                            $output = ["status" => true,
                                "token"             => $token,
                                "messages"          => "Berhasil Dihapus!, Transaksi Kredit Tabungan Qurban Pegawai <b>" . $data['nomor_transaksi'] . "</b> Atas Nama " . $get_balance[0]->nama_lengkap . " (" . $get_balance[0]->nip . ") telah dihapus. Silahkan cek Rekap/Histori Tabungan menu Daftar Tabungan Qurban Pegawai.",
                            ];
                        } else {
    ...
    public function delete_tht_credit_transaction_employee()
    {
        $param = $this->input->post();
        $data  = $this->security->xss_clean($param);
            ...
            if ($data['nip'] && $data['id_transaksi'] && $data['nomor_transaksi'] && $data['password']) {
                ...
                if (password_verify($data['password'], $check_pass[0]->password)) {
                    ...
                    if ($get_transaction == true && $get_balance == true) {
                        ...
                        $data['saldo_akhir'] = $get_balance[0]->saldo_tabungan_tht - $get_transaction[0]->nominal;

                        $update_balance = $this->SavingsModel->update_tht_balance_saving_employee($data['nip'], $data['saldo_akhir']);
                        $delete         = $this->SavingsModel->delete_tht_transaction_employee($data['id_transaksi']);

                        if ($update_balance == true && $delete == true) {

                            $output = ["status" => true,
                                "token"             => $token,
                                "messages"          => "Berhasil Dihapus!, Transaksi Kredit Tabungan Wisata Pegawai <b>" . $data['nomor_transaksi'] . "</b> Atas Nama " . $get_balance[0]->nama_lengkap . " (" . $get_balance[0]->nip . ") telah dihapus. Silahkan cek Rekap/Histori Tabungan menu Daftar Tabungan Wisata Pegawai.",
                            ];
                        } else {
                ...
                if (password_verify($data['password'], $check_pass[0]->password)) {
                    ...
                    if ($get_transaction == true && $get_balance == true) {
                        ...
                        if ($update_balance == true && $delete == true) {
                            ...
                            $output = ["status" => true,
                                "token"             => $token,
                                "messages"          => "Berhasil Dihapus!, Debet Tabungan Bersama <b>" . $data['nomor_transaksi_bersama'] . "</b> Atas Nama " . $get_balance[0]->nama_tabungan_bersama . " (" . $get_balance[0]->nomor_rekening_bersama . ") telah dihapus. Silahkan cek Rekap/Histori Tabungan menu Daftar Tabungan.",
                            ];
                        } else {
    ...
    public function delete_qurban_debet_transaction_employee()
    {
        $param = $this->input->post();
        $data  = $this->security->xss_clean($param);
                ...
                if (password_verify($data['password'], $check_pass[0]->password)) {
                    ...
                    if ($get_transaction == true && $get_balance == true) {
                        ...
                        if ($update_balance == true && $delete == true) {
                            ...
                            $output = ["status" => true,
                                "token"             => $token,
                                "messages"          => "Berhasil Dihapus!, Transaksi Debet Tabungan Qurban Pegawai <b>" . $data['nomor_transaksi'] . "</b> Atas Nama " . $get_balance[0]->nama_lengkap . " (" . $get_balance[0]->nip . ") telah dihapus. Silahkan cek Rekap/Histori Tabungan menu Daftar Tabungan Pegawai.",
                            ];
                        } else {
    ...
    public function delete_tht_debet_transaction_employee()
    {
        $param = $this->input->post();
        $data  = $this->security->xss_clean($param);
                ...
                if (password_verify($data['password'], $check_pass[0]->password)) {
                    ...
                    if ($get_transaction == true && $get_balance == true) {
                        ...
                        if ($update_balance == true && $delete == true) {
                            ...
                            $output = ["status" => true,
                                "token"             => $token,
                                "messages"          => "Berhasil Dihapus!, Transaksi Debet Tabungan Wisata <b>" . $data['nomor_transaksi'] . "</b> Atas Nama " . $get_balance[0]->nama_lengkap . " (" . $get_balance[0]->nip . ") telah dihapus. Silahkan cek Rekap/Histori Tabungan menu Daftar Tabungan.",
                            ];
                        } else {
        ...
        if (! empty($this->user_finance) && in_array($this->user_finance[0]->id_role_struktur, $this->allowed_roles)) {
            ...
            if ($data['id_nasabah'] == "" or empty($data['id_nasabah']) or $data['id_nasabah'] == null) {
                ...
                if ($check_student_name_and_number) {
                    ...
                    $data['password'] = password_hash(paramEncrypt(trim($data['nis'])), PASSWORD_DEFAULT, ['cost' => 12]);
                }
    ...
    public function update_import_employee_saving()
    {
        ...
        if (! empty($this->user_finance) && in_array($this->user_finance[0]->id_role_struktur, $this->allowed_roles)) {
            ...
            if ($data['id_nasabah'] == "" or empty($data['id_nasabah']) or $data['id_nasabah'] == null) {
                ...
                $check = $this->SavingsModel->get_number_employee_saving($data['nip']);
                if ($check) {
                    $data['status_nasabah'] = '1';
                } else {
                    $check_import = $this->SavingsModel->get_number_import_employee_saving($data['nip']);
                    if ($check_import >= 2) {
                        $data['status_nasabah'] = '3';
                ...
                $check_transition = $this->SavingsModel->get_number_name_import_employee_saving($data['nip'], strtoupper($data['nama_nasabah']));
                if ($check_transition >= 2) {
                    $data['status_nama_nasabah'] = '3';
                } else if (($check_transition == 1) && (strtoupper($data['nama_nasabah']) != strtoupper($data['old_nama_nasabah']))) {
                    $data['status_nama_nasabah'] = '3';
                } else {
                    $result = $this->SavingsModel->check_match_name_emp(trim($data['nama_nasabah']));
                ...
                $check_employee_name_and_number = $this->SavingsModel->check_employee_by_name_and_number(trim($data['nip']), trim($data['nama_nasabah']));
                ...
                $update_employee = $this->SavingsModel->update_import_employee_saving($data['id_nasabah'], $data);
    ...
    public function update_import_joint_saving()
    {
        ...
        if (! empty($this->user_finance) && in_array($this->user_finance[0]->id_role_struktur, $this->allowed_roles)) {
            ...
            if ($data['id_nasabah_bersama'] == "" or empty($data['id_nasabah_bersama']) or $data['id_nasabah_bersama'] == null) {
                ...
                $check_pj = $this->SavingsModel->get_student_and_employee_number($data['id_penanggung_jawab']);
                if ($check_pj) {
                    $data['status_pj'] = '1';
                } else {
                    $data['status_pj'] = '2';
                ...
                if ($this->googleCaptachStore($recaptchaResponse, $userIp) == 1) {
                    ...
                    if (isset($_FILES['file_personal_saving']['name']) && in_array($_FILES['file_personal_saving']['type'], $file_mimes)) {
                        ...
                        for ($i = 1; $i < count($sheetData); $i++) {
                            ...
                            if (strtoupper($sheetData[$i]['9']) == 'AKTIF') {
                                $status_siswa = '1';
                            } else if (strtoupper($sheetData[$i]['9']) == 'TIDAK_AKTIF' or strtoupper($sheetData[$i]['9']) == 'TIDAK AKTIF') {
                                $status_siswa = '0';
                            }
                            ...
                            if ($sheetData[$i]['0']) {
                                $data_array[$i] = [
                                    ...
                                    'status_siswa'        => (filter_var(trim($status_siswa), FILTER_SANITIZE_STRING)),
                                ];
                            }
                        }
            ...
            if (password_verify(($data['pin_verification']), $check_pass[0]->pin_akun)) {
                ...
                if ($this->googleCaptachStore($recaptchaResponse, $userIp) == 1) {
                    ...
                    if (isset($_FILES['file_employee_saving']['name']) && in_array($_FILES['file_employee_saving']['type'], $file_mimes)) {
                        $this->SavingsModel->clear_import_data_employee_saving();
                        ...
                        for ($i = 1; $i < count($sheetData); $i++) {
                            ...
                            $employee = $this->SavingsModel->get_employee_nip($sheetData[$i]['0']);
                            ...
                            if (! $employee) {
                                ...
                                $check_employee_name_and_number = $this->SavingsModel->check_employee_by_name_and_number(trim($sheetData[$i]['0']), trim(preg_replace("/['\"-]/", "", $sheetData[$i]['1'])));
                                if ($check_employee_name_and_number) {
                            ...
                            if (strtoupper($sheetData[$i]['6']) == 'TETAP') {
                                ...
                                $status_pegawai = '3';
                            } else if (strtoupper($sheetData[$i]['6']) == 'KELUAR') {
                                $status_pegawai = '4';
                            }
                ...
                if ($this->googleCaptachStore($recaptchaResponse, $userIp) == 1) {
                    ...
                    if (isset($_FILES['file_joint_saving']['name']) && in_array($_FILES['file_joint_saving']['type'], $file_mimes)) {
                        ...
                        for ($i = 1; $i < count($sheetData); $i++) {
                            ...
                            $student = $this->SavingsModel->get_student_and_employee_number($sheetData[$i]['1']);
                            if ($student) {
                                $status_number = '1';
                            } else {
                                $status_number = '2';
                            ...
                            if (strtoupper($sheetData[$i]['7']) == 'KOMITE') {
                                $jenis_tabungan = '1';
                            } else if (strtoupper($sheetData[$i]['7']) == 'KELAS') {
                                $jenis_tabungan = '2';
                            }
                            ...
                            if ($sheetData[$i]['0']) {
                                $data_array[$i] = [
                                    ...
                                    'id_penanggung_jawab'     => (filter_var(trim($sheetData[$i]['1']), FILTER_SANITIZE_STRING)),
                                    ...
                                    'jenis_tabungan'          => (filter_var(trim($jenis_tabungan), FILTER_SANITIZE_STRING)),
                                    ...
                                    'status_penanggung_jawab' => (filter_var(trim($status_number), FILTER_SANITIZE_STRING)),
                                ];
                            }
                        }
    ...
    public function accept_import_employee_saving()
    {
        ...
        if ($data['data_check'] == '' or $data['data_check'] == null || empty($data['data_check'] || ! $data['data_check'])) {
            ...
            if (password_verify(($data['password']), $check_pass[0]->password)) {
                ...
                $check_used_number = $this->SavingsModel->check_used_number_import_data_employee_saving($data['data_check']);
                if ($check_used_number >= 1 && $data['status_similiar'] == 'false') {
                    ...
                    $check_duplicate = $this->SavingsModel->check_duplicate_import_data_employee_saving($data['data_check']);
                    if ($check_duplicate >= 1 && $data['status_similiar'] == 'false') {
                        $output = ["status" => false,
                            "confirm"           => false,
                            "token"             => $token,
                        ...
                        $check_similiar = $this->SavingsModel->check_similiar_import_data_employee_saving($data['data_check']);
                        if ($check_similiar >= 1 && $data['status_similiar'] == 'false') {
                            $output = ["status" => true,
                                "confirm"           => true,
                                "token"             => $token,
                            ...
                            $input = $this->SavingsModel->accept_import_data_employee_saving($data['data_check']);
                            if ($input == true) {
                                ...
                                $result_import = $this->SavingsModel->get_import_employee_saving($data['data_check'], 2);
                                ...
                                for ($i = 0; $i < count($result_import); $i++) {
                                    ...
                                    if ($result_import[$i]['saldo_wisata'] != 0 && $result_import[$i]['saldo_wisata'] != null && $result_import[$i]['saldo_wisata'] != "" && ! empty($result_import[$i]['saldo_wisata'])) {
                                        ...
                                        $transaksi_wisata[$i] = [
                                            'nomor_transaksi_tht' => "TPT01" . $random_number . "/" . date('YmdHis'),
                                            'id_pegawai'          => $this->user_finance[0]->id_akun_keuangan,
                                            'id_tingkat'          => $result_import[$i]['tingkat'],
                                            'nip_pegawai'         => $result_import[$i]['nip'],
                                            'nominal'             => $result_import[$i]['saldo_wisata'],
                                ...
                                if ($transaksi_wisata) {
                                    $this->db2->insert_batch('transaksi_tabungan_tht_pegawai', $transaksi_wisata);
                                }
    ...
    public function reject_import_employee_saving()
    {
        ...
        $token = $this->security->get_csrf_hash();
        $input = $this->SavingsModel->clear_import_data_employee_saving();
        ...
        if (! empty($this->user_finance) && in_array($this->user_finance[0]->id_role_struktur, $this->allowed_roles)) {
            ...
            if ($id_nasabah) {
                ...
                if (password_verify($password, $check_pass[0]->password)) {
                    ...
                    $delete = $this->SavingsModel->delete_import_employee_saving_by_id($id_nasabah);
