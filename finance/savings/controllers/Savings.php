...
class Savings extends MX_Controller
{
    ...
    public function saving_tour_transaction_employee()
    {
        $data['nav_save'] = 'menu-item-here';
        $data['structure'] = $this->SavingsModel->get_structure_account();
        $data['schoolyear'] = $this->SavingsModel->get_schoolyear();
        ...
        if ($this->user_finance[0]->id_role_struktur == 7 || $this->user_finance[0]->id_role_struktur == 5) {
            $this->template->load('template_finance/template_finance', 'finance_savings_tour_transaction_employee', $data);
        } else {
            $datas['title'] = 'ERROR | PAGE NOT FOUND';
            $this->load->view('error_404', $datas);
        }
    ...
    public function get_all_tour_transaction_employee()
    {
        $param = $this->input->get();
        $get = $this->security->xss_clean($param);

        $data = $this->SavingsModel->get_all_tour_transaction_savings_employee($get['start_date'], $get['end_date']);
    ...
    public function get_employee_tour_info($nip = '')
    {
        $data['info_pegawai'] = $this->SavingsModel->get_employee_by_nip($nip);
        $data['info_tabungan'] = $this->SavingsModel->get_info_employee_transaction_tour($nip);
    ...
    public function get_employee_info_recap($nip = '')
    {
        ...
        $data['info_tabungan_wisata'] = $this->SavingsModel->get_info_employee_transaction_tour($nip);
    ...
    public function post_tour_credit_employee()
    {
        $param = $this->input->post();
        $data = $this->security->xss_clean($param);
        ...
        $random_number = str_pad(rand(0, pow(10, 2) - 1), 2, '0', STR_PAD_LEFT);
        $data['status_kredit_debet'] = "1";
        $data['nomor_transaksi_wisata'] = "TPW01" . $random_number . "/" . date('YmdHis');
        $get_balance = $this->SavingsModel->get_employee_balance($data['nip']);
        ...
        if ($this->user_finance[0]->id_role_struktur == 7 || $this->user_finance[0]->id_role_struktur == 5) {
            ...
            if ($data == false or empty($data['nip'])) {
                ...
                if (password_verify($data['pin_verification_kredit'], $check_pin[0]->pin_akun)) {
                    ...
                    $input_credit = $this->SavingsModel->insert_tour_credit_saving_employee($this->user_finance[0]->id_akun_keuangan, $data);
                    $update_balance = $this->SavingsModel->update_tour_balance_saving_employee($data['nip'], $data['saldo_akhir']);
    ...
    public function post_tour_credit_new_client_employee()
    {
        $param = $this->input->post();
        $data = $this->security->xss_clean($param);
        ...
        if ($this->user_finance[0]->id_role_struktur == 7 || $this->user_finance[0]->id_role_struktur == 5) {
            ...
            if ($data == false or empty($data['nip'])) {
                ...
                if (password_verify($data['pin_verification_kredit'], $check_pin[0]->pin_akun)) {
                    ...
                    $input_client = $this->SavingsModel->insert_tour_client_employee($data);
                    $input_credit = $this->SavingsModel->insert_tour_credit_saving_employee($this->user_finance[0]->id_akun_keuangan, $data);
    ...
    public function update_tour_credit_employee()
    {
        $param = $this->input->post();
        $data = $this->security->xss_clean($param);

        $get_transaction = $this->SavingsModel->get_employee_transaction_tour_last($data['id_transaksi']);
        $get_balance = $this->SavingsModel->get_employee_balance($data['nip']);
        ...
        if ($this->user_finance[0]->id_role_struktur == 7 || $this->user_finance[0]->id_role_struktur == 5) {
            ...
            if ($data == false or empty($data['nip']) or empty($data['id_transaksi'])) {
                ...
                if (password_verify($data['pin_verification_kredit_edit'], $check_pin[0]->pin_akun)) {
                    ...
                    $update_credit = $this->SavingsModel->update_tour_credit_saving_employee($data['id_transaksi'], $data);
                    $update_balance = $this->SavingsModel->update_tour_balance_saving_employee($data['nip'], $data['saldo_akhir']);
    ...
    public function post_tour_debet_employee()
    {
        $param = $this->input->post();
        $data = $this->security->xss_clean($param);
        ...
        $data['jenis_tabungan'] = "3";
        $data['status_kredit_debet'] = "2";
        $data['nomor_transaksi_wisata'] = "TPW02" . $random_number . "/" . date('YmdHis');
        $get_balance = $this->SavingsModel->get_employee_balance($data['nip']);
            ...
            if ($data == false or empty($data['nip'])) {
                ...
                if (password_verify($data['pin_verification_debet'], $check_pin[0]->pin_akun)) {
                    ...
                    if (($get_balance[0]->saldo_tabungan_wisata > 0) && ($data['nominal'] <= $get_balance[0]->saldo_tabungan_wisata)) {
                        ...
                        $input_debet = $this->SavingsModel->insert_tour_debet_saving_employee($this->user_finance[0]->id_akun_keuangan, $data);
                        $update_balance = $this->SavingsModel->update_tour_balance_saving_employee($data['nip'], $data['saldo_akhir']);
    ...
    public function update_tour_debet_employee()
    {
        $param = $this->input->post();
        $data = $this->security->xss_clean($param);
            ...
            if ($data == false or empty($data['nip']) or empty($data['id_transaksi'])) {
                ...
                if (password_verify($data['pin_verification_debet_edit'], $check_pin[0]->pin_akun)) {
                    ...
                    if ((($get_transaction[0]->saldo + $get_transaction[0]->nominal) > 0) && ($data['nominal'] <= ($get_transaction[0]->saldo + $get_transaction[0]->nominal))) {
                        ...
                        $update_debet = $this->SavingsModel->update_tour_debet_saving_employee($data['id_transaksi'], $data);
                        $update_balance = $this->SavingsModel->update_tour_balance_saving_employee($data['nip'], $data['saldo_akhir']);
    ...
    public function delete_tour_credit_transaction_employee()
    {
        $param = $this->input->post();
        $data = $this->security->xss_clean($param);
            ...
            if ($data['nip'] && $data['id_transaksi'] && $data['nomor_transaksi'] && $data['password']) {
                ...
                if (password_verify($data['password'], $check_pass[0]->password)) {
                    ...
                    if ($get_transaction == true && $get_balance == true) {
                        ...
                        $update_balance = $this->SavingsModel->update_tour_balance_saving_employee($data['nip'], $data['saldo_akhir']);
                        $delete = $this->SavingsModel->delete_tour_transaction_employee($data['id_transaksi']);
    ...
    public function delete_tour_debet_transaction_employee()
    {
        $param = $this->input->post();
        $data = $this->security->xss_clean($param);
        ...
        if ($this->user_finance[0]->id_role_struktur == 7 || $this->user_finance[0]->id_role_struktur == 5) {
            ...
            if ($data['id_nasabah'] == "" or empty($data['id_nasabah']) or $data['id_nasabah'] == null) {
                ...
                if ($check_employee_name_and_number) {
                    ...
                    $data['password'] = password_hash(paramEncrypt(trim($data['nip'])), PASSWORD_DEFAULT, array('cost' => 12));
                }
    ...
    public function add_ajax_position($id_pos = '', $id_jab = '')
    {
        ...
        $query = $this->db2->get_where('jabatan', array('level_tingkat' => $id_pos));
