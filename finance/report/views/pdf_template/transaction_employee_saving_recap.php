...
<body
    ...
    <table width="100%">
        <tr>
            <td colspan="2"></td>
            <td><strong>Judul:</strong> Rekap Tabungan Pegawai
                <?php echo strtoupper($nama_pegawai); ?>
            </td>
...
if (!empty($saving)) {
    foreach ($saving as $key => $value) {
        ...
        } else if ($value->jenis_tabungan == 3) {
        ...
        ?>
            <tr>
                ...
                <td align="left"><b><?php echo $nama_tabungan; ?></b></td>
                <td align="left"><b><?php echo $jenis_transaksi; ?></b></td>
