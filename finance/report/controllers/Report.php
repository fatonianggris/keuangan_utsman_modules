...
class Report extends MX_Controller
{
    ...
    public function export_data_employee_csv_all()
    {
        $this->load->helper('download');
        ...
        if ($data['data_check'] == '' or $data['data_check'] == null || empty($data['data_check'] || ! $data['data_check'])) {
            ...
            $empInfo = $this->ReportModel->get_data_employee_saving_excel_all($data['data_check'], $data['start_date'], $data['end_date']);
            //            var_dump($empInfo);
            //            exit;
            $spreadsheet = new Spreadsheet();
            $sheet       = $spreadsheet->getActiveSheet();
            ...
            $sheet->setCellValue('E2', 'Tingkat');
            $sheet->setCellValue('F2', 'Nomor Handphone');
            $sheet->setCellValue('G2', 'Email');
            $sheet->setCellValue('H2', 'Status Pegawai');
            $sheet->setCellValue('I2', 'Kredit Umum');
            ...
            foreach ($empInfo as $element) {
                ...
                if ($element['jenis_pegawai'] == '1') {
                    $status_pegawai = 'TETAP';
                } else if ($element['jenis_pegawai'] == '2') {
                ...
                $sheet->setCellValue('B' . $rowCount, strtoupper($element['nama_lengkap']));
                $sheet->setCellValue('C' . $rowCount, strtoupper($element['hasil_nama_jabatan']));
                $sheet->setCellValue('D' . $rowCount, $jk);
                $sheet->setCellValue('E' . $rowCount, $tingkat);
                $sheet->setCellValue('F' . $rowCount, $element['nomor_hp']);
                $sheet->setCellValue('G' . $rowCount, $element['email']);
                $sheet->setCellValue('H' . $rowCount, $status_pegawai);
                $sheet->setCellValue('I' . $rowCount, $element['kredit_umum']);
                $sheet->setCellValue('J' . $rowCount, $element['debet_umum']);
                $sheet->setCellValue('K' . $rowCount, $element['saldo_umum']);

                $rowCount++;
            }

            $sheet->setCellValue('H' . $rowCount, 'TOTAL');
            $sheet->setCellValue('I' . $rowCount, ($total_kredit_um));
            $sheet->setCellValue('J' . $rowCount, ($total_debit_um));
            $sheet->setCellValue('K' . $rowCount, ($total_saldo_um));

            $sheet->getStyle('H' . $rowCount . ':L' . $rowCount)->getFont()->setBold(true);
    ...
    public function export_data_joint_saving_csv_all()
    {
        ...
        if ($data['data_check'] == '' or $data['data_check'] == null || empty($data['data_check'] || ! $data['data_check'])) {
            ...
            foreach ($empInfo as $element) {
                ...
                $sheet->setCellValue('J' . $rowCount, $jenis_tabungan);
            ...
            $sheet->getStyle('G' . $rowCount . ':I' . $rowCount)->getFont()->setBold(true);
    ...
    public function export_data_csv_transaction_general_all_employee()
    {
        $this->load->helper('download');
        ...
        $fileName = 'Laporan_Transaksi_Tabungan_Umum_Pegawai _' . $data['date_range'];
        ...
        if ($data['data_check'] == '' or $data['data_check'] == null || empty($data['data_check'] || ! $data['data_check'])) {
            ...
            $empInfo = $this->ReportModel->get_data_saving_excel_transaction_general_all_employee($data['data_check']);
            //            var_dump($empInfo);
            //            exit;
            $spreadsheet = new Spreadsheet();
            $sheet       = $spreadsheet->getActiveSheet();
    ...
    public function export_data_csv_transaction_qurban_all_employee()
    {
        $this->load->helper('download');
        ...
        $fileName = 'Laporan_Transaksi_Tabungan_Qurban_Pegawai_' . $data['date_range'];
        ...
        if ($data['data_check'] == '' or $data['data_check'] == null || empty($data['data_check'] || ! $data['data_check'])) {
            ...
            $empInfo = $this->ReportModel->get_data_saving_excel_transaction_qurban_all_employee($data['data_check']);
            //            var_dump($empInfo);
            //            exit;
            $spreadsheet = new Spreadsheet();
            $sheet       = $spreadsheet->getActiveSheet();
    ...
    public function export_data_csv_transaction_employee_recap_all()
    {
        $this->load->helper('download');
        ...
        $fileName = 'Laporan_Tabungan_Pegawai_' . trim(strtoupper($data['nama_pegawai'])) . '_' . $data['date_range'];
